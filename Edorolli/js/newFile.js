    ...
    bank: [
      {
        id: "bri",
        name: "BANK BRI",
        detail: "transfer ke (ATM, BRI Mobile, Internet Banking)",
        fee: "Rp. 0",
        logo: "bank BRI.png",
      },
      {
        id: "bca",
        name: "BCA",
        detail: "transfer ke (ATM, m_BCA, Internet Banking)",
        fee: "Rp. 2.500",
        logo: "bank BCA.png",
      },
      {
        id: "mandiri",
        name: "mandiri",
        detail: "transfer ke (ATM, mandiri Mobile, Internet Banking)",
        fee: "Rp. 1.000",
        logo: "bank Mandiri.jpeg",
      },
      {
        id: "bni",
        name: "BNI",
        detail: "transfer ke (ATM, BNI Mobile, Internet Banking)",
        fee: "Rp. 2.500",
        logo: "bank BNI.png",
      },
    ],
    ...
    dropdowns[i]
      ...
      .addEventListener("click", function () {
        ...
        for (let j = 0; j < dropdowns.length; j++) {
          if (
            dropdowns[j].querySelector(".dropdown-content") !== currentDropdown
          ) {
            dropdowns[j]
