...
<body>
            ...
            <div class="sidebar">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="#"><i class="far fa-file-alt"></i> Booking Confirmation</a></li>
                        <li class="active"><a href="#"><i class="fas fa-cogs"></i> Kelola Akun</a></li>
                        <li><a href="Provider_KSandi.php?action=logout" id="logoutBtn"><i class="fas fa-sign-out-alt"></i> Keluar</a></li>
                    </ul>
                </nav>
            </div>
            <div class="content">
    ...
    <script>
        ...
        document.getElementById('confirmBtnLO').addEventListener('click', function() {
            window.location.href = 'Provider_KSandi.php?action=logout';
        });
    </script>
